...
import com.example.game.constant.CommonField;
import com.example.game.entity.ChatMessage;
import com.example.game.entity.GameMatchInfo;
import com.example.game.entity.MessageReply;
import com.example.game.entity.UserMatchInfo;
import com.example.game.error.GameServerError;
import com.example.game.exception.GameServerException;
import com.example.game.service.QuestionSev;
import com.example.game.utils.MatchCacheUtil;
import com.example.game.utils.MessageCode;
import com.example.game.utils.MessageTypeEnum;
import com.example.game.utils.StatusEnum;
...
public class ChatWebsocket {
    ...
    private Session session;//存储当前会话

    private String userId;//当前id
...
//    private  RestTemplate restTemplate;
    ...
    private void matchUser(JSONObject jsonObject) {
        ...
        Thread matchThread = new Thread(() -> {
            ...
            ArrayList o = restTemplate.postForObject("http://124.221.195.197:8888/getQuestion/",
                    null, ArrayList.class);
            gameMatchInfo.setQuestions(o);
