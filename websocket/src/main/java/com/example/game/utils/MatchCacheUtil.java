...
import com.example.game.websocket.ChatWebsocket;
import com.example.game.redis.EnumRedisKey;
...
public class MatchCacheUtil {
    ...
    public String getUserInMatchRandom(String userId) {
        Optional<Map.Entry<Object, Object>> any
                = redisTemplate.opsForHash().entries(EnumRedisKey.USER_STATUS.getKey())
